// JavaScript Document
			...
			$(function() {
			  ...
			  //create new container for images
				$("<div>").attr("id", "scrollcontainer").css({ position:"absolute"}).width(1500).height(70).appendTo("div#viewer");
				...
				*/
				...
				$("#ltr").live("click", function() {
					...
					//swap class names
					$("div#scrollcontainer").removeClass("rtl").addClass("ltr");
										
					//work out total travel distance
					var totalDistance = parseInt($("div#scrollcontainer").width()) + parseInt($("div#viewer").width());
					
					//work out remaining distance
					var distanceLeft = totalDistance - (parseInt($("div#scrollcontainer").css("left")) + parseInt($("div#scrollcontainer").width()));
					
					//new duration is distance left / speed)
					var newDuration = distanceLeft / speed;
					
					//restart anim
					animator($("div#scrollcontainer"), newDuration, "ltr");
				});
				...
				$("#rtl").live("click", function() {
					...
					//swap class names
					$("div#scrollcontainer").removeClass("ltr").addClass("rtl");
					
					//work out total travel distance
					var totalDistance = parseInt($("div#scrollcontainer").width()) + parseInt($("div#viewer").width());

					//work out remaining distance
					var distanceLeft = totalDistance - (parseInt($("div#viewer").width()) - (parseInt($("div#scrollcontainer").css("left"))));
					
					//new duration is distance left / speed)
					var newDuration = distanceLeft / speed;
				
					//restart anim
					animator($("div#scrollcontainer"), newDuration, "rtl");
				});
			});